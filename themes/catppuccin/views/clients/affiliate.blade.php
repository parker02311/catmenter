                    ...
                    <div class="flex flex-col gap-2 mt-2">
                        ...
                        @if (config('settings::affiliate'))
                            <a href="{{ route('clients.affiliate') }}"
                                class="pl-3 border-ctp-blue border-l-2 duration-300 hover:text-ctp-text hover:pl-3 hover:border-ctp-blue focus:text-ctp-text focus:pl-3 focus:border-ctp-blue">
                                {{ __('Affiliate') }}
                            </a>
                        @endif
                    </div>
