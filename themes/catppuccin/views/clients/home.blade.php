    ...
    <div class="content">
        ...
        <div class="grid grid-cols-12 gap-4">
            <div class="col-span-12 relative">
                ...
                <div class="bg-ctp-blue p-4 rounded-xl text-ctp-base">
            ...
            <div class="lg:col-span-3 col-span-12 flex-col">
                <div class="bg-ctp-mantle border-2 border-ctp-surface0 dark:border-0 rounded-xl">
                    <div class="flex items-center border-b-2 p-3.5 border-ctp-surface0">
                    ...
                    <div class="flex flex-col items-center">
                        ...
                        <div class="text-center">
                            <p class="text-ctp-blue font-bold text-lg mt-2">
                                {{__('Hurray! No invoices to pay')}}
                            </p>
                        </div>
                        @endif
                        @foreach ($invoices as $invoice)
                        <div class="hover:bg-ctp-surface0 transition-all border-b-[1px] border-ctp-surface0 ease-out hover:ease-in cursor-pointer w-full p-3" onclick="window.location.href='{{ route('clients.invoice.show', $invoice->id) }}'">
                            <div class="flex flex-row">
                                <div class="flex my-auto text-2xl ms-2 w-1/12 justify-center text-ctp-subtext0">
            ...
            <div class="lg:col-span-9 col-span-12">
                <div class="content-box">
                    <table class="w-full">
                        <thead class="border-b-2 border-ctp-surface0 text-ctp-subtext0">
                            <tr>
                        ...
                        <tbody>
                            ...
                            @continue
                            @endif
                            <tr class="@if($loop1->index < ($loop1->count - $loop->count )) border-b-2 border-ctp-surface0 @endif">
                                ...
                                <td class="py-3 flex">
                                    ...
                                    <span class="relative flex ml-2">
                                        <a class="button @if($product2->status !== 'pending' || $product2->status !== 'suspended') cursor-pointer bg-ctp-crust hidden @else button-secondary @endif" @if($product2->status === 'pending' || $product2->status === 'suspended') href='{{ route('clients.invoice.index') }}'@endif><i class="ri-money-dollar-circle-line"></i></a>
                                        @if($product2->status === 'pending' || $product2->status === 'suspended')
                                        <span class="animate-ping -top-1 -right-1 absolute inline-flex h-3 w-3 rounded-full bg-ctp-red opacity-75"></span>
                                        <span class="absolute inline-flex -top-1 -right-1 rounded-full h-3 w-3 bg-ctp-red"></span>
                                        @endif
                                    </span>
                                </td>
                            </tr>
                            ...
                            @elseif (count($services) <= 0)
                                ...
                                <tr class="w-full">
                                    <td colspan="4" class="text-ctp-blue pt-5 w-full font-bold text-lg text-center">
