<x-app-layout clients title="{{ __('Create Ticket') }}">
    <div class="py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-ctp-mantle shadow-xl sm:rounded-lg">
                <x-success class="mb-4" />
                <div class="grid grid-cols-1 bg-ctp-mantle bg-opacity-25">
                    <div class="p-6">
                        ...
                        <div class="ml-5">
                            <div class="mt-2 text-sm text-ctp-subtext0">
