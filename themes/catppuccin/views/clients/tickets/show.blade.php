<x-app-layout clients title="{{ __('Ticket') }}">
    ...
    <div class="py-4 sm:py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div
                class="overflow-hidden bg-ctp-mantle shadow-xl sm:rounded-lg">
                <div class="p-5 bg-ctp-mantle sm:px-10">
                    <x-success class="mt-4" />
                    <div class="justify-between flex flex-row items-center">
                        <h1 class="text-2xl font-bold ">{{__('Ticket')}} #{{
                            $ticket->id }}</h1>
                ...
                <div class="ml-10 flex items-baseline ">
                    <p class="px-3 rounded-md text-xl m-4">
                        {{ __('No messages yet') }}
                    </p>
                </div>
                @else
                <div
                    class="md:p-6 bg-ctp-mantle sm:px-20 border-b border-ctp-surface0">
                    <div class="mt-6">
                                ...
                                <div class="grid grid-cols-12 place-items-end w-fit">
                                    <div class="col-span-10 md:col-span-11">
                                        ...
                                        <div class="w-full flex justify-end">
                                            <div
                                                class="w-full hyphens-auto supports-[overflow-wrap:anywhere]:[overflow-wrap:anywhere] supports-[not(overflow-wrap:anywhere)]:[word-break:normal] text-white dark:text-white-400 rounded-2xl bg-ctp-blue p-2 px-4 mr-2">
                ...
                @endempty
                <br>
                <div class="overflow-hidden bg-ctp-mantle shadow-xl sm:rounded-b-lg ">
                    @if($ticket->status == "closed")
                    <div class="p-6 text-center text-ctp-red bg-ctp-crust sm:px-20  mx-auto my-auto">
                    ...
                    <form method="POST" action="{{ route('clients.tickets.reply', $ticket->id) }}" class="mt-2"
                        ...
                        @csrf
                        <div
                            class="bg-ctp-mantle mb-5 sm:px-20 mt-5">
                            <h1 class="text-xl  font-bold">{{ __('Reply') }}</h1>
                            <div class="grid grid-cols-1 gap-4">
                                <div class="mt-3  ">
                                    ...
                                    <div class="flex flex-row">
                                        ...
                                        <textarea id="message"
                                            class="block my-auto w-full rounded-2xl shadow-sm focus:ring-ctp-blue focus:border-ctp-blue border-ctp-blue dark:border-0 sm:text-sm bg-ctp-crust"
