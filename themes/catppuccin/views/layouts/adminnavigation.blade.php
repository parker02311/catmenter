<nav class="bg-ctp-mantle">
    <div class="px-4 max-w-7xl sm:px-6 lg:px-8">
        <div class="flex items-center h-16 text-sm font-medium leading-5 text-gray-500 hover:text-gray-700">
            ...
            <div class="absolute right-0 hidden w-full lg:flex lg:items-center lg:w-auto" id="menu">
                <div class="relative inline-block text-left">
                    <button type="button" class="inline-flex items-center justify-center w-full px-2 py-2 text-base font-medium text-gray-700 bg-ctp-mantle dark:text-darkmodetext" aria-label="User menu" aria-haspopup="true" data-dropdown-toggle="user-menu">
                        <!-- use gravatar -->
            ...
            <div class="px-2 pt-2 pb-3 space-y-1">
                ...
                @auth
                    <div class="w-full" id="menu">
                        <div class="relative inline-block text-left">
                            <button type="button" class="inline-flex items-center justify-center w-full px-2 py-2 text-base font-medium text-gray-700 bg-ctp-mantle dark:text-darkmodetext" aria-label="User menu" aria-haspopup="true" data-dropdown-toggle="user-menu-mobile">
                                <!-- use gravatar -->
                                <img class="w-8 h-8 rounded-md" src="https://www.gravatar.com/avatar/{{ md5(Auth::user()->email) }}?s=200&d=mp" alt="{{ Auth::user()->name }}" />
                                <p class="p-2 font-bold">
                                    {{ Auth::user()->name }}
