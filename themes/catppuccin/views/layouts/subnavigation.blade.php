@if (config('settings::sidebar') == 0)
    <div class="bg-ctp-mantle dark:border-0 dark:border-t-2 border-b-2 md:block border-ctp-surface0 hidden" id="clientsNavBar">
...
@else
    ...
    <div class="shrink-0 md:w-64 w-72 hidden sm:block md:sticky fixed top-0" id="clientsNavBar">
        <div class="bg-ctp-mantle dark:border-0 border-r-2 border-secondary-200 h-screen sticky top-0 px-4 py-2 flex flex-col">
