                ...
                <div class="grid grid-cols-12 place-items-end">
                    <div class="col-span-10 md:col-span-11">
                        ...
                        <div class="w-full flex justify-end">
                            <div
                                class="w-full hyphens-auto supports-[overflow-wrap:anywhere]:[overflow-wrap:anywhere] supports-[not(overflow-wrap:anywhere)]:[word-break:normal] text-black dark:text-white rounded-2xl bg-ctp-blue p-2 px-4 mr-2">
