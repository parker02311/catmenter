    ...
    <div class="grid grid-cols-12 gap-4">
        <div class="lg:col-span-8 col-span-12">
            <div class="content-box overflow-hidden">
                ...
                <hr class="my-2 border-ctp-surface0">
                <div>
                        ...
                        <div class="mt-4">
                            ...
                            <div class="flex flex-row flex-wrap mt-2 mb-4 gap-4">
                                ...
                                @foreach ($priceTypes as $priceType)
                                    @if ($prices->{$priceType})
                                        <button type="button"
                                            class="button button-secondary flex flex-col items-center p-4 px-5 ring-offset-primary-400 ring-ctp-blue @if ($billing_cycle == $priceType) ring-2 @endif"
                                            ...
                                            @if ($prices->{$priceType . '_setup'})
                                                <div class="text-sm text-ctp-surface0">{{ __('Setup fee') }}: <x-money
                        ...
                        @foreach ($configItems as $item)
                            ...
                            <div class="mt-2">
                                ...
                                @elseif($item->type == 'radio')
                                    <div class="mt-2">
                                        <label for="{{ $item->id }}"
                                            class="text-sm text-ctp-surface0">{{ ucfirst($name) }}</label>
                                            ...
                                            @foreach ($items as $key => $option)
                                                ...
                                                <div class="flex flex-col w-full gap-1">
                                                    ...
                                                    <div class="flex flex-col justify-center items-center w-full">
                                                        <div class="text-xs text-ctp-surface0">{{ ucfirst($name) }}
                                                        </div>
                                                        @if ($option->configurableOptionInputPrice->{$billing_cycle})
                                                            <div class="text-xs text-ctp-surface0">
                                                                <x-money :amount="$option->configurableOptionInputPrice
                                                                    ->{$billing_cycle}" />
                                                            </div>
                                                        @endif
            ...
            <div class="content-box">
                ...
                <div class="mt-2">
                    <div class="flex flex-row justify-between">
                        <div class="text-sm text-ctp-surface0">{{ $product->name }}</div>
                        <div class="text-sm text-ctp-surface0">
                    ...
                    @foreach ($userConfig as $uconfig)
                        ...
                        @endif
                        <div class="flex flex-row justify-between">
                            <div class="text-sm text-ctp-surface0">{{ $uconfig->name }}</div>
                            <div class="text-sm text-ctp-surface0">
                    ...
                    <hr class="my-2 border-ctp-surface0">
                    <div class="flex flex-row justify-between">
                        <div class="text-sm text-ctp-surface0">{{ __('Total') }}</div>
                        <div class="text-sm text-ctp-surface0">
