<x-app-layout title="home">
    ...
    @if ($categories->count() > 0)
        <div class="content">
            <h2 class="font-semibold text-2xl mb-2">{{ __('Categories') }}</h2>
                    ...
                    @if (($category->products()->where('hidden', false)->count() > 0 && !$category->category_id) || $category->children()->count() > 0)
                        <div class="lg:col-span-3 md:col-span-6 col-span-12">
                            <div class="content-box h-full flex flex-col">
                                ...
                                <div class="prose dark:prose-invert">@markdownify(strlen($category->description) > 100 ? substr($category->description, 0, 100) . '...' : $category->description)</div>
                ...
                @foreach ($announcements->sortByDesc('created_at') as $announcement)
                    <div class="lg:col-span-4 md:col-span-6 col-span-12">
                        <div class="content-box">
                            ...
                            <div class="prose text-ctp-subtext0">@markdownify(strlen($announcement->announcement) > 100 ? substr($announcement->announcement, 0, 100) . '...' : $announcement->announcement)</div>
